...
export default function RectangleIconIcon({
  weight = "regular",
  className = "",
  ...
  switch (weight) {
    case "black":
      return (
        ...
        >
          <path
            d="              M5.3597 27.1113H27.6717C31.0487 27.1113 33.0317 25.1293 33.0317 21.7523V5.3592C33.0317 1.9683 31.0487 0.0003 27.6717 0.0003H5.3597C1.9827 0.0003 -0.0003 1.9683 -0.0003 5.3592V21.7523C-0.0003 25.1293 1.9827 27.1113 5.3597 27.1113ZM6.0977 22.2583C5.2637 22.2583 4.8537 21.9023 4.8537 21.0003V6.0972C4.8537 5.1953 5.2637 4.8532 6.0977 4.8532H26.9337C27.7677 4.8532 28.1777 5.1953 28.1777 6.0972V21.0003C28.1777 21.9023 27.7677 22.2583 26.9337 22.2583Z"
            fill="currentColor"
          />
        </svg>
      )
    ...
    case "light":
      return (
        ...
        >
          <path
            d="              M4.0337 24.7601H27.9867C30.6657 24.7601 32.0197 23.3921 32.0197 20.7671V3.9921C32.0197 1.3671 30.6657 0.0001 27.9867 0.0001H4.0337C1.3677 0.0001 -0.0003 1.3531 -0.0003 3.9921V20.7671C-0.0003 23.4061 1.3677 24.7601 4.0337 24.7601ZM4.0607 23.0641C2.5297 23.0641 1.6957 22.2581 1.6957 20.6721V4.0881C1.6957 2.5021 2.5297 1.6951 4.0607 1.6951H27.9587C29.4627 1.6951 30.3247 2.5021 30.3247 4.0881V20.6721C30.3247 22.2581 29.4627 23.0641 27.9587 23.0641Z"
            fill="currentColor"
          />
        </svg>
      )
    ...
    case "regular":
      return (
        ...
        >
          <path
            d="              M4.2927 25.1702H27.9457C30.8167 25.1702 32.2387 23.7622 32.2387 20.9452V4.2382C32.2387 1.4222 30.8167 0.0002 27.9457 0.0002H4.2927C1.4357 0.0002 -0.0003 1.4222 -0.0003 4.2382V20.9452C-0.0003 23.7622 1.4357 25.1702 4.2927 25.1702ZM4.3207 22.9692C2.9527 22.9692 2.2017 22.2442 2.2017 20.8222V4.3612C2.2017 2.9392 2.9527 2.2012 4.3207 2.2012H27.9177C29.2717 2.2012 30.0367 2.9392 30.0367 4.3612V20.8222C30.0367 22.2442 29.2717 22.9692 27.9177 22.9692Z"
            fill="currentColor"
          />
        </svg>
      )
    case "semibold":
      return (
        ...
        >
          <path
            d="              M4.6347 25.785H27.8637C30.8847 25.785 32.4977 24.186 32.4977 21.191V4.594C32.4977 1.6 30.8847 0 27.8637 0H4.6347C1.6137 0 -0.0003 1.586 -0.0003 4.594V21.191C-0.0003 24.199 1.6137 25.785 4.6347 25.785ZM4.8947 22.736C3.6917 22.736 3.0487 22.135 3.0487 20.877V4.908C3.0487 3.65 3.6917 3.049 4.8947 3.049H27.6037C28.7927 3.049 29.4497 3.65 29.4497 4.908V20.877C29.4497 22.135 28.7927 22.736 27.6037 22.736Z"
            fill="currentColor"
          />
        </svg>
      )
