...
export default function RectanglePortraitRighthalfFilledIconIcon({
  weight = "regular",
  className = "",
  ...
  switch (weight) {
    ...
    case "light":
      return (
        ...
        >
          <path
            d="              M-0.0003 25.102C-0.0003 27.768 1.3537 29.135 3.9927 29.135H18.6077C21.2597 29.135 22.5997 27.768 22.5997 25.102V4.02C22.5997 1.354 21.2597 0 18.6077 0H3.9927C1.3537 0 -0.0003 1.354 -0.0003 4.02ZM1.6957 25.061V4.061C1.6957 2.516 2.5017 1.682 4.0877 1.682H11.3067V27.439H4.0877C2.5017 27.439 1.6957 26.606 1.6957 25.061Z"
            fill="currentColor"
          />
        </svg>
      )
    ...
    case "ultralight":
      return (
        ...
        >
          <path
            d="              M-0.0003 25.2656C-0.0003 27.5626 1.2167 28.7796 3.5137 28.7796H18.3207C20.6037 28.7796 21.8207 27.5626 21.8207 25.2656V3.5136C21.8207 1.2166 20.6037 -0.0004 18.3207 -0.0004H3.5137C1.2167 -0.0004 -0.0003 1.2166 -0.0003 3.5136ZM0.6697 25.2386V3.5406C0.6697 1.6546 1.6547 0.6696 3.5407 0.6696H10.9097V28.1096H3.5407C1.6547 28.1096 0.6697 27.1246 0.6697 25.2386Z"
            fill="currentColor"
          />
        </svg>
      )
