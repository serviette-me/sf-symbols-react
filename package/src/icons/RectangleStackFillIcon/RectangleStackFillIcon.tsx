...
export default function RectangleStackFillIconIcon({
  weight = "regular",
  className = "",
  ...
  switch (weight) {
    ...
    case "semibold":
      return (
        ...
        >
          <path
            d="              M5.5647 1.941H22.9277C22.8317 0.684 22.0667 0 20.7267 0H7.7657C6.4257 0 5.6597 0.684 5.5647 1.941ZM2.8027 6.002H25.6897C25.5117 4.676 24.8147 3.896 23.2967 3.896H5.1957C3.6777 3.896 2.9937 4.676 2.8027 6.002ZM4.4707 30.912H24.0077C26.9337 30.912 28.4787 29.367 28.4787 26.469V12.688C28.4787 9.803 26.9337 8.244 24.0077 8.244H4.4707C1.5447 8.244 -0.0003 9.789 -0.0003 12.688V26.469C-0.0003 29.367 1.5447 30.912 4.4707 30.912Z"
            fill="currentColor"
          />
        </svg>
      )
    ...
    case "ultralight":
      return (
        ...
        >
          <path
            d="              M5.5507 0.684H22.9007C22.9007 0.328 22.6407 0 22.2847 0H6.1657C5.8107 0 5.5507 0.328 5.5507 0.684ZM3.0217 3.637H25.4297C25.4297 3.281 25.1697 2.953 24.8007 2.953H3.6507C3.2817 2.953 3.0217 3.281 3.0217 3.637ZM3.5137 27.754H24.9377C27.2347 27.754 28.4517 26.496 28.4517 24.24V9.775C28.4517 7.506 27.2347 6.262 24.9377 6.262H3.5137C1.2167 6.262 -0.0003 7.478 -0.0003 9.775V24.24C-0.0003 26.523 1.2167 27.754 3.5137 27.754Z"
            fill="currentColor"
          />
        </svg>
      )
